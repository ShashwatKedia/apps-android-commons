...
public class MapUtils {
    ...
    public static final LatLng defaultLatLng = new fr.free.nrw.commons.location.LatLng(51.50550,
        -0.07520, 1f);

    public static void centerMapToPlace(Place placeToCenter, MapboxMap mapBox,
        Place lastPlaceToCenter, Context context) {
    ...
    public static void registerUnregisterLocationListener(final boolean removeLocationListener,
        LocationServiceManager locationManager, LocationUpdateListener locationUpdateListener) {
        try {
