...
public class AchievementsFragment extends CommonsDaggerSupportFragment {
    ...
    /**
     * This method helps in the creation Achievement screen and dynamically set the size of
     * imageView
     *
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (sessionManager.getUserName() == null || sessionManager.getUserName().equals(userName)) {
            ...
            binding.tvAchievementsOfUser.setText(
    ...
    /**
     * Shows a snack bar which has an action button which on click dismisses the snackbar and
     * invokes the listener passed
     *
    ...
    private void setImageRevertPercentage(int notRevertPercentage) {
        ...
        binding.imagesRevertLimitText.setText(
     ...
     * level. Also stores the achievements level of the user in BasicKvStore to display in menu
     *
     * @param achievements
     */
    private void inflateAchievements(Achievements achievements) {
        ...
        binding.achievementBadgeImage.setImageDrawable(
            VectorDrawableCompat.create(getResources(), R.drawable.badge,
