...
public class LeaderboardConstants {
    ...
    /**
     * This is the size of the page i.e. number items to load in a batch when pagination is
     * performed
     */
    ...
    /**
     * This is the prefix of the user's homepage url, appending the username will give us complete
     * url
     */
    ...
    /**
     * This is the a constant string for the state loaded, when the pages are loaded we can use this
     * constant to identify if we need to show the progress bar or not
     */
