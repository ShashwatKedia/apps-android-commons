...
public interface ReviewInterface {
    ...
    /**
     * Fetch recent changes from MediaWiki API Calls the API for the latest 50 changes (the default
     * limit is 10) More data can be fetched beyond this limit as the API call includes a
     * continuation field However, since it takes longer to check the review status from the
     * database and display the images as they get repeated before more data is fetched in the
     * background the limit is increased from 10 to 50 using gcmlimit
     */
